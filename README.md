...
[![codecov](https://codecov.io/gh/DocShield-Labs/didactic/graph/badge.svg?token=CX8LYHW6ZL)](https://codecov.io/gh/DocShield-Labs/didactic)
...
```typescript
import { didactic, within, oneOf, exact, unordered, numeric } from '@docshield/didactic';
